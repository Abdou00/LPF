...
$pdo = new PDO('mysql:host=localhost;dbname=id7000678_dialogue',  
               'id7000678_christophe',   
               'christophe',      
...
if (!empty($_POST)) {
    ...
    $_POST['message'] = htmlspecialchars($_POST['message'], ENT_QUOTES);  // convertit les caractères spéciaux (<, >, &, '', "") en entités HTML inoffensives (par exmple le > devient &gt;). Ainsi les balises <style> ou <script> saisies dans le formulaire deviennent inopérantes.
    ...
    // Pour se prémunir des injections SQL, nous faisons la requêt préparée suivante :
