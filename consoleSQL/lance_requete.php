...
<html lang="fr">
  ...
  <body>
    <div class="container">
    <h1 style="text-align: center;">Lance-Requêtes</h1>
    ...
    <form method="post" action="">
      ...
      <div class="form-group">
            ...
            <textarea class="form-control" id="requete" name="requete" placeholder="Entrer votre requête" style="height: 100px";><?php echo $requete ?></textarea><br />
      </div>
      <div class="form-group">
        <select name="bdd_selection" class="form-control" style="width: 49%; display: inline-block;">
          <option value="toutes">Toutes les Base De Données</option>
          <?php echo $choix_bdd; ?>
        </select>
      </div>
