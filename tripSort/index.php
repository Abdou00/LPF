...
//                    console.log(res);
                    if(res.code){
                        ...
                        var trainSeat = (res.trainroute.trainSeat) ? res.trainroute.trainSeat : "Not Known";
                        //Flight vars
                        ...
                        var flightSeat = (res.flightroute.flightSeat) ? res.flightroute.flightSeat : "Not Known";
                        ...
                        " <li>Take Train " + trainName + " from " + trainStatA + " TO " + trainStatB +" Take a Seat in Seat No. " + trainSeat + "</li>" +
                        " <li>Take Flight " + flightName + " from " + airportA + " TO " + res.flightroute.airportB + ", Gate " + res.flightroute.gate + ". Take a Seat No. " + flightSeat + "</li>"  +
                        " <li>Take Flight " + flightName + " from " + airportA + " TO " + res.flightroute.airportB + ", Gate " + res.flightroute.gate + ". Take a Seat No. " + flightSeat + "</li>"  +
