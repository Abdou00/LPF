...
?>
    <div class="lien">
        <button type="button" class="btn btn-success" style="margin-left:21%;"><a href="form.php?op=new" style="color:white;">Ajouter formation</a></button>
    </div>
    ...
    <table class="contacts">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                <button type="button" class="btn btn-success"><a href="form.php?op=delete&id=<?php echo $form->id_formation; ?>"style="color:white;">
                        Delete
                    </a></button>
                </td>
                <td>
                <button type="button" class="btn btn-success"><a href="form.php?op=update&id=<?php echo $form->id_formation; ?>"style="color:white;">
                        Edite
                    </a></button>
                </td>
            </tr>
