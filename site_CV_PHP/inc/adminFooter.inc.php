        ...
        <script src="<?php echo URL; ?>/public/vendor/datatables/jquery.dataTables.js"></script>
        <script src="<?php echo URL; ?>/public/vendor/datatables/dataTables.bootstrap4.js"></script>

        <!-- Custom scripts for all pages-->
        <script src="<?php echo URL; ?>/public/js/sb-admin.min.js"></script>
    </body>
</html>
